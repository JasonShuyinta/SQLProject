  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 offset-3">
        <form class="text-center border border-light p-5" action="inserisci specie animale2.php" method="post">
          <p class="h4 mb-4"> Inserimento di una specie animale </p>
          ...
          <div class="form-group">
            <label> Numerosita </label>
            <input type="text" class="form-control" placeholder="Numerosita" name="Numerosita" required>
          </div>
